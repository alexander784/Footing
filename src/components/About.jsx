...
const About = () => {
  ...
  return (
    <div className='h-screen'>
      ...
      >
        <h2 className="text-black text-3xl font-bold text-center mb-8 absolute top-8">About</h2>
        <div className="flex flex-col md:flex-row items-start gap-8 z-10">
          <div className="flex-1">
            <div className="p-4">
              <h3 className="text-black text-xl font-bold mb-2">Fueled by enthusiasm, shaped by expertise</h3>
