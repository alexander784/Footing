  ...
  useEffect(() => {
    const fetchSignings = async () => {
      try {
        ...
        console.log('signings:', signingsList);
  ...
  return (
    <div className="bg-gray-900 min-h-screen p-4"> 
      <div className="max-w-4xl mx-auto mt-8">
        <h2 className="text-2xl md:text-3xl font-bold mb-4 text-white text-center">Recent Signings</h2>
        {signings.length === 0 ? (
          <p className="text-center text-gray-400">No signings available.</p>
        ) : (
